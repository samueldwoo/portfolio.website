...
import { stripLocation } from './lib/strip-location.mjs';
...
/* ===========================================================================
   LOCATION SURGERY lives in ./lib/strip-location.mjs

   It was moved there so it could be tested — this file cannot be imported
   without running an export, so for a long time the strip had no test at all
   and `PLAN.md` §6 recorded it as never verified. `npm run test:strip-location`
   is that test. The ARGUMENT for how the surgery works — length preservation,
   zeroing before unlinking, MakerNote, XMP as latin1 — stays in this file's
   header above, which is still its only home.
   =========================================================================== */
